...
class AdminOrder extends Component
{
    ...
    header()
    {
        return (
            ...
            <TableCell className="hc" style={{textAlign:'center'}}><h4>Some field</h4></TableCell>
            <TableCell className="hc" style={{textAlign:'center'}}><h4>Some another filed</h4></TableCell>
            </>
        );
    }
    body(){
        return this.state.items.map((item) => {
            ...
            return (
                ...
                <TableCell className="bc" align="center">Some Field</TableCell>
                <TableCell className="bc" align="center">Some Another Field</TableCell>
                </TableRow>
                </>
            )
        })
